...
import os
from relation.evaluate import metric
import torch
...
class MyCallBack(Callback):
    ...
    def on_epoch_end(self):
        ...
        self.logging('epoch {:3d}, f1: {:4.4f}, precision: {:4.4f}, recall: {:4.4f}'
        ...
        if f1_score > self.best_f1_score:
            ...
            self.logging("Saving the model, epoch: {:3d}, best f1: {:4.4f}, precision: {:4.4f}, recall: {:4.4f}".
    ...
    def on_train_end(self):
        ...
        self.logging("best epoch: {:3d}, best f1: {:4.4f}, precision: {:4.4f}, recall: {:4.2}".
