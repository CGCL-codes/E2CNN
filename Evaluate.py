...
from model_addMarker.casRel import CasRel
from model_addMarker.callback import MyCallBack
from model_addMarker.data import load_data, get_data_iterator
from model_addMarker.config import Config
from model_addMarker.evaluate import evaluate_raw_text, metric
...
parser.add_argument('--dataset', default='finance_0217', type=str, help='define your own dataset names')
parser.add_argument("--bert_name", default='./pretrain_model/chinese-roberta-wwm-ext', type=str, help='choose pretrained bert name')
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(os.path.join(con.save_weights_dir, con.weights_save_name)))
